      ...
      if (screen === 'welcome') {
        return (
          <WelcomeScreen
            ...
            handleContinueStudent={handleContinueStudent}
      ...
      if (screen === 'student-library') {
        ...
        return (
          <StudentLibraryScreen
            ...
            setScreen={setScreen}
            showHiddenTests={showHiddenTests}
            setShowHiddenTests={setShowHiddenTests}
            handleHideCompletedTests={handleHideCompletedTests}
            ...
            setActionTargetTest={setActionTargetTest}
            setActionModalVisible={setActionModalVisible}
            handleShareFile={handleShareFile}
            handleOpenStudentQuiz={handleOpenStudentQuiz}
            handleViewStudentResults={handleViewStudentResults}
            stripDatExtension={stripDatExtension}
      ...
      if (screen === 'teacher-library') {
        return (
          <TeacherLibraryScreen
            ...
            fetchCloudRegistry={fetchCloudRegistry}
            setCloudRegistry={setCloudRegistry}
            teacherLibraryFiles={teacherLibraryFiles}
            cloudRegistry={cloudRegistry}
            teacherProfile={teacherProfile}
            handleOpenTeacherFileEditor={handleOpenTeacherFileEditor}
            handleUnpublishFromCloud={handleUnpublishFromCloud}
            handlePublishToCloud={handlePublishToCloud}
            handleShareFile={handleShareFile}
            handleDeleteLibraryFile={handleDeleteLibraryFile}
            handleCreateTeacherQuiz={handleCreateTeacherQuiz}
            handleEncryptAndSave={handleEncryptAndSave}
